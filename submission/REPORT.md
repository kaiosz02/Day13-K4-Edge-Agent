...
| Nguyễn Thị Việt Vinh | Role D: QA & Incident Analyst |`docs/dashboard_spec.md`, `submission/evidence/challenge_investigation_evidence.txt`, `submission/evidence/correlation_id_evidence.txt`, `submission/REPORT.md`| Quy trình truy vết và phân tích Incident từ Metrics đến Logs |
